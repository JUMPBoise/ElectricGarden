...
//sine variables 
 ...
 waveC = 1;  //randomizes sine wave pulse higher number fast 0-80 default 4
  ...
  LEDS.show();                    // Display the LED's at every loop cycle.  
  //-------------------------------animation loop------************---------------------- Ocean
  }
else if (State == 3) {   
 //--------------------------------animation loop-------************----------------------  Rainbowstrip MODE 
//sine variables 
 ...
 waveC = 2;  //randomizes sine wave pulse higher number fast 0-80 default 4
  ...
  LEDS.show();                    // Display the LED's at every loop cycle.  
  //-------------------------------animation loop------************---------------------- Rainbowstripe
  }
else if (State == 4) {   
 //--------------------------------animation loop-------************---------------------- Party MODE  
 //sine variables 
...
targetPalette = CRGBPalette16(PartyColors_p); //max of 4 colors
  ...
  LEDS.show();                    // Display the LED's at every loop cycle.  
  //-------------------------------animation loop------************---------------------- Party
  }
else if (State == 5) {   
 //--------------------------------animation loop-------************----------------------   Cloud MODE
 //sine variables 
